...
<?php 
	...
	$nuevo_nombre_pro =$_POST['productoventa2'];
	$nuevo_cantidad_pro = $_POST['cantidad_pro2'];
	$nuevo_precio_actual = $_POST['precio_pro2'];


	$consulta="UPDATE `ventas` SET `producto`='$nuevo_nombre_pro', `cantidad`='$nuevo_cantidad_pro', `monto`='$nuevo_precio_actual' WHERE `id_venta`='$id_productos'";
...
$resultado2 = $conexion->query($consulta);
        ...
        while($finn = $resultado2->fetch_assoc()){ 
              echo "<tr>";
              echo "<td>",$finn['id_venta'],"</td>";
                            echo "<td>",$finn['producto'],"</td>";
                            echo "<td>",$finn['cantidad'],"</td>";
                            echo "<td>",$finn['monto'],"</td>";
                            echo "<td>",$finn['fecha_venta'],"</td>";
                            
                            #echo "<td>",$fin['fecha_alta'],"</td>";
                            echo "<td><a href='editar_ventas.php?ids=".$finn["id_venta"]."'>Editar</a></td>";
                            
                            echo "<td><a href='eliminar.php?ids=".$finn["id_venta"]."'>Eliminar</a></td>";
                            echo "</tr>";

...
<?php 
	...
	$id_fecha=$_POST["id"];
	$nueva_fecha_adqui =$_POST['nueva_fecha_adqui'];
	$nueva_fecha_vencimiento = $_POST['nueva_fecha_vencimiento'];
	$nueva_fecha_modif_precio = $_POST['nueva_fecha_modif_precio'];
     
	$consulta="UPDATE `fecha_productos` SET `fecha_adqui`='$nueva_fecha_adqui', `fecha_vencimiento`='$nueva_fecha_vencimiento', `fecha_modif_precio`='$nueva_fecha_modif_precio' WHERE `id_fecha`='$id_fecha'";

    $resultado_fechas =$conexion->query($consulta);
...
<?php
require("conexion.php");
$consulta = "select * from fecha_productos";

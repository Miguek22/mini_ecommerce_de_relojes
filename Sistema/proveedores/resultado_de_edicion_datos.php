...
<?php 
	...
	$id_datos=$_POST["id"];
	$telefono_empleado=$_POST["nuevo_telefono_empleado"];
	$direccion_empleado=$_POST["nueva_direccion_empleado"];
	$dni_empleado=$_POST["nuevo_dni_empleado"];
	$consulta="UPDATE `datos_empleados` SET `telefono_empleado`='$telefono_empleado', `direccion_empleado`='$direccion_empleado', `dni_empleado`='$dni_empleado' WHERE `id_datos`='$id_datos'";

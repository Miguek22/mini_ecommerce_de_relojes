...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2021 a las 02:51:24
...
('4dor348evvftf0h668bm1p705t', 24, '2'),
('4dor348evvftf0h668bm1p705t', 38, '3');
...
--
-- Estructura de tabla para la tabla `datos_deudor`
--
...
--
-- Volcado de datos para la tabla `datos_deudor`
--
...
--
-- Estructura de tabla para la tabla `datos_personales_envio`
--
...
--
-- Volcado de datos para la tabla `datos_personales_envio`
--
...
--
-- Estructura de tabla para la tabla `detalle_ventas_online`
--
...
--
-- Estructura de tabla para la tabla `fecha_productos`
--
...
--
-- Volcado de datos para la tabla `fecha_productos`
--
...
INSERT INTO `ventas_online` (`id_venta`, `fecha_venta`, `producto`) VALUES
(1, '2021-11-19', ''),
(2, '2021-11-19', 'Lucas'),
...
--
-- Indices de la tabla `datos_deudor`
--
...
--
-- Indices de la tabla `datos_personales_envio`
--
...
--
-- Indices de la tabla `detalle_ventas_online`
--
...
--
-- Indices de la tabla `fecha_productos`
--
...
--
-- AUTO_INCREMENT de la tabla `datos_deudor`
--
ALTER TABLE `datos_deudor`
...
--
ALTER TABLE `datos_envio`
  MODIFY `id_datos_envio` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
...
--
-- AUTO_INCREMENT de la tabla `datos_personales_envio`
--
ALTER TABLE `datos_personales_envio`
  MODIFY `id_datos_personales_envio` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
...
--
-- AUTO_INCREMENT de la tabla `detalle_ventas_online`
--
ALTER TABLE `detalle_ventas_online`
...
--
-- AUTO_INCREMENT de la tabla `fecha_productos`
--
ALTER TABLE `fecha_productos`

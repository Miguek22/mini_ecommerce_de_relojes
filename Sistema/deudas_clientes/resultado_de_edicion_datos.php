...
<?php 
	...
	$id_datos=$_POST["id"];
	$dni_deudor=$_POST["nuevo_dni_deudor"];
	$direccion_deudor=$_POST["nueva_direccion_deudor"];
	$telefono_deudor=$_POST["nuevo_telefono_deudor"];
	$consulta="UPDATE `datos_deudor` SET `dni_dudor`='$dni_dudor', `direccion_deudor`='$direccion_deudor', `telefono_deudor`='$telefono_deudor' WHERE `id_datos`='$id_datos'";
...
<center><a href="registro_deudores.html">Click aqui para agregar nuevo deudor...</a></center><br>

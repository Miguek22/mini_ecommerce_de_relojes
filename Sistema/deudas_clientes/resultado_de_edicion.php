...
<?php 
	...
	$id_deuda_cliente=$_POST["id"];
	$nombre_deudor=$_POST["nombre"];
	$apellido_deudor=$_POST["apellido"];
	$monto_deuda=$_POST["monto_deuda"];
	$nuevo_nombre_empleado=$_POST["nuevo_nombre_deudor"];
	$nuevo_apellido_empleado=$_POST["nuevo_apellido_deudor"];
	$nuevo_monto_deuda=$_POST["nuevo_monto_deuda"];
	$consulta="UPDATE `deuda_clientes` SET `nombre_deudor`='$nuevo_nombre_deudor', `apellido_deudor`='$nuevo_apellido_deudor', `monto_deuda`='$nuevo_monto_deuda' WHERE `id_deuda_cliente`='$id_deuda_cliente'";

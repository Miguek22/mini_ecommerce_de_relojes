...
?>
<center><a href="Registro.html">Click aqui para agregar nuevo usuario...</a></center><br>
...
<?php		
        while($fin = $resultado->fetch_assoc()){ 
							...
							echo "<td>",$fin['contrasenia'],"</td>";
							echo "<td>",$fin['fecha_alta'],"</td>";
							echo "<td><a href='modificar_registros.php?ids=".$fin["id_usuario"]."'>Editar</a></td>";
